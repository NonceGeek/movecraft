module movecraft::planks {
    ...
    const URI: vector<u8> = b"planks.png";
    const BLOCK_TYPE: u64 = 12;
    const STACKABLE: bool = true;
    const MINTABLE: bool = false;
    ...
    public fun uri(): vector<u8>{
        *&URI
    }

    public fun block_type():u64 {
        BLOCK_TYPE
    }

    public fun stackable():bool {
        STACKABLE
    }

    public fun mintable():bool {
        MINTABLE
    }
